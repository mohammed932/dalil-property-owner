...
export class AuthService {
  ...
  public getToken(): string {
    ...
    if (!this.token || !existToken || existToken === null) {
      console.log("misho");
      this.token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI1ZDU1ZDQwMTNlYzQ5NDAwMTdmOTAxY2UiLCJtb2JpbGUiOiIrMjAxMDI4NzM0ODQ4Iiwicm9sZXMiOlsiY3VzdG9tZXIiXSwiaWF0IjoxNTY1OTA1OTIxfQ.pRYhEk72ffKXe0M--iw3UhQsoa5bIhED5wNWChfj1P8";
  ...
  public getUserData(): Observable<any> {
    return this.http.get(
      `${this.baseUrl}users/${localStorage.getItem("USER_ID")}`,
      {
        observe: "response"
      }
    );
